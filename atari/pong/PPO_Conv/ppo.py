...
from PPO_Conv.models import ActorCritic
...
class PPO_Conv():
    ...
    def __init__(self, state_dim, action_dim, entropy_beta, gamma, gae_lambda, batch_size, ppo_epsilon,
                 ppo_epochs, critic_discount):
        super(PPO_Conv, self).__init__()
        ...
        self.model = ActorCritic(state_dim, action_dim, device)
