...
from PG_Conv import wrappers
from PG_Conv.pg import PG_Conv
from PG_Conv.utils import mkdir
from PG_Conv.buffer import MeanBuffer

class PG_Conv_Trainer():
    def __init__(self, env_name, config, random_seed=42, lr_base=0.001, lr_decay=0.00005,
        ...
        self.policy = PG_Conv(self.env, self.state_dim, self.action_dim, self.config)
