...
class Actor:
    ...
    def build_model(self):
        ...
        net = layers.Dense(units=32, activation='relu', kernel_initializer=initializer)(states)
        net = layers.Dense(units=32, activation='relu', kernel_initializer=initializer)(net)
