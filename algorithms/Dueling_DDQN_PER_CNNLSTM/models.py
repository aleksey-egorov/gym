...
class DuelingNetwork(nn.Module):
    def __init__(self, num_inputs, action_space, batch_size):
        ...
        self.adv_stream_1 = nn.Linear(256, 256).to(device)
        self.adv_stream_2 = nn.Linear(256, action_space).to(device)
        self.val_stream_1 = nn.Linear(256, 256).to(device)
        self.val_stream_2 = nn.Linear(256, 1).to(device)
