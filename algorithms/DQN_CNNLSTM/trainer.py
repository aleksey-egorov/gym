...
from DQN_CNNLSTM import wrappers
from DQN_CNNLSTM.dqn import DQN_CNNLSTM
from DQN_CNNLSTM.utils import mkdir, FrameStack
from DQN_CNNLSTM.buffer import ReplayBuffer


class DQN_CNNLSTM_Trainer():
    ...
    def __init__(self, env_name, config, random_seed=42, lr_base=0.001, lr_decay=0.00005,
        ...
        self.stack_frames = 4
        self.algorithm_name = 'dqn_cnnlstm'
        ...
        self.policy = DQN_CNNLSTM(self.env, self.state_dim, self.action_dim, self.batch_size)
    ...
    def train(self):
        ...
        for episode in range(self.max_episodes):
            ...
            for t in range(self.max_timesteps):
                ...
                #print ("ENV STEP ACTION: {}".format(type(action)))
